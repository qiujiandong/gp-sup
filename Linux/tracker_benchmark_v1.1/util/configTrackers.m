...
kcfTrackers = { ...
    struct('name','KCF_GaussHog','namePaper','KCF'),...
    struct('name', 'KCF_SAHW', 'namePaper', 'KCF_SAHW'), ...
    struct('name', 'KCF_SASW','namePaper', 'KCF_SASW'), ...
    struct('name', 'KCF_SFSW','namePaper', 'KCF_SFSW'), ...
    struct('name', 'KCF_SFHW', 'namePaper', 'KCF_SFHW'), ...
    struct('name', 'KCF_SFHWNoRsz', 'namePaper', 'KCF_SFHWNoRsz'), ...
    struct('name', 'KCF_SFHWDebug', 'namePaper', 'KCF_SFHWDebug'), ...
    struct('name', 'KCF_SWModel', 'namePaper', 'KCF_SWModel'), ...
    };

trackers = kcfTrackers;
