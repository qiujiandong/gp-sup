...
static inline void CSL_TmrPeriodIntClear (CSL_TmrHandle hTmr)
{
    CSL_FINS(hTmr->regs->INTCTL_STAT, TMR_INTCTL_STAT_CMP_INT_STAT_LO, 1);
}

static inline Bool CSL_TmrhasPeriodInt (CSL_TmrHandle hTmr)
{
    return (Bool)CSL_FEXT(hTmr->regs->INTCTL_STAT, TMR_INTCTL_STAT_CMP_INT_STAT_LO);
}
