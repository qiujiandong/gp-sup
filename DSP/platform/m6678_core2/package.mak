...
package/%.xdc.inc package/%_m6678_core2.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package m6678_core2" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js m6678_core2 $@
...
.PHONY: release,m6678_core2
ifeq (,$(MK_NOGENDEPS))
-include package/rel/m6678_core2.zip.dep
endif
package/rel/m6678_core2/m6678_core2/package/package.rel.xml: package/package.bld.xml
package/rel/m6678_core2/m6678_core2/package/package.rel.xml: package/build.cfg
package/rel/m6678_core2/m6678_core2/package/package.rel.xml: package/package.xdc.inc
package/rel/m6678_core2/m6678_core2/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/m6678_core2/m6678_core2/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

m6678_core2.zip: package/rel/m6678_core2.xdc.inc package/rel/m6678_core2/m6678_core2/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/m6678_core2.xdc.inc,package/rel/m6678_core2.zip.dep)


release release,m6678_core2: all m6678_core2.zip
clean:: .clean
	-$(RM) m6678_core2.zip
	-$(RM) package/rel/m6678_core2.xdc.inc
	-$(RM) package/rel/m6678_core2.zip.dep
