...
int CFftManager::HwInit()
{
	...
	CpIntc_clearSysInt(2, EDMA3_CC1_CORE3_FFT_TRIGEVT);
	CpIntc_enableSysInt(2, EDMA3_CC1_CORE3_FFT_TRIGEVT);
	CpIntc_mapSysIntToHostInt(2, EDMA3_CC1_CORE3_FFT_TRIGEVT, EDMA3_CC1_CORE3_FFT_CICCHA);
	CpIntc_enableHostInt(2, EDMA3_CC1_CORE3_FFT_CICCHA);
	CpIntc_enableAllHostInts(2);

	// CIC0 is used to connect EMDA finish interrupt to CPU
    CpIntc_clearSysInt(0, EDMA3_CC1_CORE3_FFT_SYSEVT);
	CpIntc_enableSysInt(0, EDMA3_CC1_CORE3_FFT_SYSEVT);
	CpIntc_mapSysIntToHostInt(0, EDMA3_CC1_CORE3_FFT_SYSEVT, CORE3_INTC_FFT_HOSTINT);
	CpIntc_enableHostInt(0, CORE3_INTC_FFT_HOSTINT);
	CpIntc_enableAllHostInts(0);

    chaAttr.chaNum = EDMA3_CC1_CORE3_FFT_CHA;
    chaAttr.regionNum = CSL_EDMA3_REGION_3;

    m_hCha = CSL_edma3ChannelOpen(&m_ChaObj, CSL_TPCC_1, &chaAttr, &status);

    CSL_edma3HwChannelSetupParam(m_hCha, EDMA3_CC1_CORE3_FFT_PARAM);
    CSL_edma3HwChannelSetupQue(m_hCha, EDMA3_CC1_CORE3_FFT_QUE);
...
int CFftManager::FFT_R2R_T(float *pSrc, float *pDst, int nLen, int nRows)
{
    ...
    hParam = CSL_edma3GetChaParamHandle(m_hCha, EDMA3_CC1_CORE3_FFT_PARAM, &status);
    paramSetup.option = CSL_EDMA3_OPT_MAKE(CSL_EDMA3_ITCCH_EN, \
										   CSL_EDMA3_TCCH_EN, \
										   CSL_EDMA3_ITCINT_DIS, \
										   CSL_EDMA3_TCINT_DIS, \
										   EDMA3_CC1_CORE3_FFT_CHA, \
	...
	paramSetup.linkBcntrld = CSL_EDMA3_LINKBCNTRLD_MAKE((EDMA3_CC1_CORE3_FFT_PARAM + 1) << 5, 0);
	paramSetup.srcDstCidx = CSL_EDMA3_CIDX_MAKE(nLen*4, 4); // (src, dst)
	paramSetup.cCnt = nRows;
	CSL_edma3ParamSetup(hParam, &paramSetup);

	hParam = CSL_edma3GetChaParamHandle(m_hCha, EDMA3_CC1_CORE3_FFT_PARAM + 1, &status);
    paramSetup.option = CSL_EDMA3_OPT_MAKE(CSL_EDMA3_ITCCH_EN, \
										   CSL_EDMA3_TCCH_DIS, \
										   CSL_EDMA3_ITCINT_DIS, \
										   CSL_EDMA3_TCINT_EN, \
...
void CFftManager::ClearInterruptFlag()
{
    ...
    CpIntc_clearSysInt(m_nCicId, EDMA3_CC1_CORE3_FFT_SYSEVT);
}
