...
proc create_hier_cell_hier_ddr { parentCell nameHier } {
  ...
  connect_bd_net -net mig_7series_0_ui_addn_clk_0 [get_bd_pins ui_addn_clk_0] [get_bd_pins mig_7series_0/ui_addn_clk_0] [get_bd_pins rst_mig_7series_0_80M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  ...
  connect_bd_net -net rst_mig_7series_0_80M_peripheral_aresetn [get_bd_pins peripheral_aresetn1] [get_bd_pins rst_mig_7series_0_80M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.PARAM_GAMA {"000000000000000000000000000001111000101"} \
   CONFIG.PARAM_TRUNCATE {"000000000000000000000000000001100110011"} \
   CONFIG.QN {12} \
   CONFIG.TOTAL_BIT_WIDTH {39} \
  ...
  # Create port connections
  connect_bd_net -net M00_ACLK_1 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins hier_ddr/ui_clk] [get_bd_pins xdma_0_axi_periph/ACLK]
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins hier_ddr/peripheral_aresetn] [get_bd_pins xdma_0_axi_periph/ARESETN]
  connect_bd_net -net M03_ACLK_1 [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins hier_ddr/ui_addn_clk_0] [get_bd_pins hog_mdl_only_axi_lite_0/aclk] [get_bd_pins xdma_0_axi_periph/M02_ACLK] [get_bd_pins xdma_0_axi_periph/M03_ACLK]
  ...
  connect_bd_net -net rst_mig_7series_0_80M_peripheral_aresetn [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins hier_ddr/peripheral_aresetn1] [get_bd_pins hog_mdl_only_axi_lite_0/arest_n] [get_bd_pins xdma_0_axi_periph/M02_ARESETN] [get_bd_pins xdma_0_axi_periph/M03_ARESETN]
  connect_bd_net -net rst_srio_gen2_0_156M_peripheral_aresetn [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins hier_srio/peripheral_aresetn] [get_bd_pins hier_xdma/ARESETN1] [get_bd_pins srio_pcie_bridge_0/aresetn] [get_bd_pins xdma_0_axi_periph/M00_ARESETN] [get_bd_pins xdma_0_axi_periph/M01_ARESETN]
  connect_bd_net -net srio_gen2_0_log_clk_out [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins hier_srio/log_clk_out] [get_bd_pins hier_xdma/ACLK1] [get_bd_pins srio_pcie_bridge_0/aclk] [get_bd_pins xdma_0_axi_periph/M00_ACLK] [get_bd_pins xdma_0_axi_periph/M01_ACLK]
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins hier_xdma/ACLK] [get_bd_pins xdma_0_axi_periph/S00_ACLK]
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins hier_xdma/ARESETN] [get_bd_pins xdma_0_axi_periph/S00_ARESETN]
